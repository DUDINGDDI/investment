...
-- 마스터 데이터 초기화 (TRUNCATE 후 재삽입)
-- zones, booths, stock_booths, app_settings 은 유지
...
-- (11, 'renew', 7, 1, TRUE, '2026-02-20 09:30:00');
-- 
-- dream 미션 (target=1)
-- INSERT INTO user_missions (user_id, mission_id, progress, target, is_completed, completed_at) VALUES
-- (11, 'dream', 1, 1, TRUE, '2026-02-20 10:00:00');
-- 
-- result 미션 (target=1)
-- INSERT INTO user_missions (user_id, mission_id, progress, target, is_completed, completed_at) VALUES
-- (11, 'result', 1, 1, TRUE, '2026-02-20 09:15:00');
-- 
-- again 미션 (target=70, progress는 70 이상도 가능)
-- INSERT INTO user_missions (user_id, mission_id, progress, target, is_completed, completed_at) VALUES
-- (11, 'again', 95, 70, TRUE, '2026-02-20 14:00:00');
-- 
-- sincere 미션 (target=12, progress는 12 이상도 가능)
-- INSERT INTO user_missions (user_id, mission_id, progress, target, is_completed, completed_at) VALUES
-- (11, 'sincere', 18, 12, TRUE, '2026-02-20 15:00:00');
-- 
-- together 미션 (target=1)
-- INSERT INTO user_missions (user_id, mission_id, progress, target, is_completed, completed_at) VALUES
-- (11, 'together', 1, 1, TRUE, '2026-02-20 11:30:00');
-- ──────────────────────────────────────────────