...
@Entity
@Table(name = "booth_ratings", uniqueConstraints = {
        @UniqueConstraint(name = "uk_user_booth_br", columnNames = {"user_id", "booth_id"})
})
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class BoothRating {
    ...
    public BoothRating(User user, Booth booth, Integer scoreFirst, Integer scoreBest,
