...
public class UserService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        return new LoginResponse(user.getId(), user.getName(), user.getCompany(), user.getBalance(), token, user.getIsExecutive());
    }
    ...
    public UserResponse getUser(Long userId) {
        ...
        return new UserResponse(user.getId(), user.getUniqueCode(), user.getName(), user.getCompany(), user.getBalance(), user.getIsExecutive());
    }
