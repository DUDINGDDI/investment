...
export const stockApi = {
  ...
  updateComment: (boothId: number, commentId: number, content: string) => api.put<StockCommentResponse>(`/stocks/booths/${boothId}/comments/${commentId}`, { content }),
  deleteComment: (boothId: number, commentId: number) => api.delete(`/stocks/booths/${boothId}/comments/${commentId}`),
...
export const adminApi = {
  ...
  useAllTickets: (userId: number) =>
    api.post<{ userId: number; usedCount: number; usedMissions: string[] }>('/admin/tickets/use-all', { userId }),
