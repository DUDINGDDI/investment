...
('CJ CGV 2번부스', '영화/극장',
 ...
 '글로벌 멀티플렉스 극장 체인', 12, '🎥', '#F39C12', 2, UUID()),
...
('CJ프레시웨이 2번부스', '식자재 유통',
 ...
 '식자재 유통·단체급식 전문 기업', 14, '🥬', '#27AE60', 3, UUID()),
...
('CJ푸드빌 2번부스', '외식',
 ...
 '빕스·뚜레쥬르 종합 외식 기업', 16, '🍽️', '#E67E22', 3, UUID()),

('CJ온스타일 1번부스', '커머스',
 'TV홈쇼핑, 라이브커머스, 모바일 쇼핑을 아우르는 멀티채널 커머스 플랫폼입니다.',
 '멀티채널 라이브 커머스 플랫폼', 17, '🛍️', '#FF6348', 3, UUID()),
('CJ온스타일 2번부스', '커머스',
 '데이터 기반 큐레이션으로 차별화된 쇼핑 경험을 제공합니다.',
 '멀티채널 라이브 커머스 플랫폼', 18, '🛍️', '#FF6348', 3, UUID()),
